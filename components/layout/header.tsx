...
export function Header({ onNewGroup, onShowHowItWorks, onGoHome, inPlanner }: HeaderProps) {
      ...
      <div className="container mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="h-9 px-3 text-xs font-bold gap-1.5 rounded-lg border-border/70 hover:bg-muted tracking-wide"
          ...
          <Button
            ...
            className="h-9 w-9 rounded-lg bg-neutral-900 dark:bg-neutral-800 text-white border-neutral-800 dark:border-neutral-700 hover:bg-neutral-800 dark:hover:bg-neutral-700 hover:text-white transition-colors shadow-sm cursor-pointer"
