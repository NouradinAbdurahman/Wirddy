...
export function ScheduleView({
  ...
  return (
    <div className="mx-auto w-full max-w-5xl space-y-5 pb-16 print:max-w-none print:p-0">
      {/* Top Navigation & Action Bar (Hidden in Print) */}
      <div className="flex flex-col justify-between gap-3 border-b border-border/40 pb-3.5 sm:flex-row sm:items-center print:hidden">
