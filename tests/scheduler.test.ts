...
import { validateGeneratedSchedule, validateScheduleInput } from '../lib/scheduler/validator';
...
describe('Scheduler Input Validation Tests', () => {
  it('rejects empty group name', () => {
    const input: ScheduleInput = {
      ...
      members: [{ id: '1', name: 'Ali', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 30 }],
    };
  ...
  it('rejects total != 30', () => {
    const input: ScheduleInput = {
      ...
      members: [
        { id: '1', name: 'Ali', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 10 },
        { id: '2', name: 'Omar', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 15 },
      ],
    };
    const result = validateScheduleInput(input);
    expect(result.isValid).toBe(false);
  ...
  it('rejects member weekly amount exceeding known range', () => {
    const input: ScheduleInput = {
      ...
      members: [
        { id: '1', name: 'Asia', knowledgeType: 'juz_range', startJuz: 29, endJuz: 30, weeklyAmount: 4 },
        { id: '2', name: 'Ali', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 26 },
      ],
    };
    const result = validateScheduleInput(input);
    expect(result.isValid).toBe(false);
    expect(result.errors.some((e) => e.code === 'AMOUNT_EXCEEDS_KNOWLEDGE')).toBe(true);
  });
});
...
describe('Scheduling Engine & Multi-Week Rotation Tests', () => {
  it('generates a valid schedule for 1 member reading 30 Juz', () => {
    const input: ScheduleInput = {
      ...
      members: [{ id: '1', name: 'Abdulrahman', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 30 }],
    };
  ...
  it('generates and rotates schedule for 6 members reading 5 Juz each across 5 weeks', () => {
    const input: ScheduleInput = {
      ...
      members: [
        { id: 'm1', name: 'Member 1', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 5 },
        { id: 'm2', name: 'Member 2', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 5 },
        { id: 'm3', name: 'Member 3', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 5 },
        { id: 'm4', name: 'Member 4', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 5 },
        { id: 'm5', name: 'Member 5', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 5 },
        { id: 'm6', name: 'Member 6', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 5 },
      ],
    };
    ...
    const m1Assignments = schedule.weeks.map(
      (w) => w.assignments.find((a) => a.memberId === 'm1')!
    );
  ...
  it('respects restricted knowledge member (PRD Section 55 Example)', () => {
    ...
    const input: ScheduleInput = {
      ...
      members: [
        { id: 'm1', name: 'Abdulrahman', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 5 },
        { id: 'm2', name: 'Ismail', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 2 },
        { id: 'm3', name: 'Asia', knowledgeType: 'juz_range', startJuz: 26, endJuz: 30, weeklyAmount: 2 },
        { id: 'm4', name: 'Fatima', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 5 },
        { id: 'm5', name: 'Hassan', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 4 },
        { id: 'm6', name: 'Mariam', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 4 },
        { id: 'm7', name: 'Zaid', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 4 },
        { id: 'm8', name: 'Amina', knowledgeType: 'entire', startJuz: 1, endJuz: 30, weeklyAmount: 4 },
      ],
    };
